const indexPart = require('./index.js');
const dataPart = require("../data.js");
...
const getLocalData = () => {
    return localStorage.getItem('data') 
        ...
        : dataPart.agoraStatesDiscussions;
};
...
const onClickPageBtn = (list, focusNum = 0) => {
    indexPart.addPagenationBtn(list);
    ...
    Array.prototype.forEach.call(pageBtn, (v, i) => {
        v.addEventListener('click', (e) => {
            ...
            indexPart.render(list, Number(e.target.textContent - 1));
        });
    });
};
...
const onClickDeleteBtn = (element, index, list) => {
    ...
    element.addEventListener('click', () => {
        ...
        indexPart.render(list, Number(focusPage.textContent) - 1);
    });
};
...
module.exports = {mount, getLocalData, onClickDeleteBtn, hoverContentEvent};