...
export const render = (data, focus) => {
...
export const addPagenationBtn = (data) => {
...
const addDeleteBtn = (element, index) => {
    ...
    events.hoverContentEvent(element, discussionDeleteBtn);
    events.onClickDeleteBtn(discussionDeleteBtn, index, discussions);
};
...
const discussions = events.getLocalData();
events.mount(discussions);
